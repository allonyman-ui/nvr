      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'How to Write an Invoice Payment Reminder Email', item: 'https://chase.allonys.com/blog/how-to-write-invoice-payment-reminder-email' },
          ],
        }) }}
      />
