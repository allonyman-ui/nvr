      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'How to Collect Overdue Invoices Without Losing the Client', item: 'https://chase.allonys.com/blog/how-to-collect-overdue-invoices' },
          ],
        }) }}
      />
